...
def eval(args):
    ...
    with fluid.program_guard(test_prog, startup):
        with fluid.unique_name.guard():
            input = fluid.data(name='image', shape=(None,test_config.TEST.seg_num*3,model_para['sample']['seglen']*3,test_config.TEST.target_size,test_config.TEST.target_size), dtype='float32')
